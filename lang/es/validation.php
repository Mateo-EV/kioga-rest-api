...
return [
    ...
    */
    ...
    "gte" => [
        ...
        "file" =>
            "El campo :attribute debe ser mayor o igual a :value kilobytes.",
        "numeric" => "El campo :attribute debe ser mayor o igual a :value.",
        "string" =>
            "El campo :attribute debe ser mayor o igual a :value caracteres."
    ],
    ...
    "lte" => [
        ...
        "file" =>
            "El campo :attribute debe ser menor o igual a :value kilobytes.",
        "numeric" => "El campo :attribute debe ser menor o igual a :value.",
        "string" =>
            "El campo :attribute debe ser menor o igual a :value caracteres."
    ],
    ...
    "missing_with" =>
        "El campo :attribute debe estar ausente cuando :values está presente.",
    "missing_with_all" =>
        "El campo :attribute debe estar ausente cuando :values están presentes.",
    ...
    "password" => [
        ...
        "mixed" =>
            "El campo :attribute debe contener al menos una letra mayúscula y una minúscula.",
        "numbers" => "El campo :attribute debe contener al menos un número.",
        "symbols" => "El campo :attribute debe contener al menos un símbolo.",
        "uncompromised" =>
            "El :attribute dado ha aparecido en una filtración de datos. Por favor, elija un :attribute diferente."
    ],
    ...
    "present_with" =>
        "El campo :attribute debe estar presente cuando :values está presente.",
    "present_with_all" =>
        "El campo :attribute debe estar presente cuando :values están presentes.",
    ...
    "required_if_accepted" =>
        "El campo :attribute es obligatorio cuando :other es aceptado.",
    "required_if_declined" =>
        "El campo :attribute es obligatorio cuando :other es rechazado.",
    "required_unless" =>
    ...
    "required_without_all" =>
        "El campo :attribute es obligatorio cuando ninguno de :values están presentes.",
